        ...
        <form action="{{ route('clients.update', $client) }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="cpf" id="cpf" value="{{ old('cpf', $client->cpf) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $client->phone_number) }}" required
                ...
                <div>
                    ...
                    <select name="profession" id="profession" required
                        ...
                        @foreach(\App\Enums\Profession::cases() as $profession)
                            <option value="{{ $profession->value }}" {{ old('profession', $client->profession?->value) == $profession->value ? 'selected' : '' }}>
                                {{ $profession->label() }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="mt-8 pt-8 border-t border-gray-200">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="cep" id="cep" value="{{ old('cep', $client->address->cep ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="city" id="city" value="{{ old('city', $client->address->city ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="state" id="state" value="{{ old('state', $client->address->state ?? '') }}"
                            placeholder="SP"
                    ...
                    <div>
                        ...
                        <input type="text" name="district" id="district" value="{{ old('district', $client->address->district ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="street" id="street" value="{{ old('street', $client->address->street ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="address_number" id="address_number" value="{{ old('address_number', $client->address->address_number ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="complement_number" id="complement_number" value="{{ old('complement_number', $client->address->complement_number ?? '') }}"
                    ...
                    <div>
                        ...
                        <select name="country" id="country"
                            ...
                            <option value="br" {{ old('country', $client->address->country ?? 'br') == 'br' ? 'selected' : '' }}>Brasil</option>
                            <option value="us" {{ old('country', $client->address->country ?? '') == 'us' ? 'selected' : '' }}>Estados Unidos</option>
                            <option value="ca" {{ old('country', $client->address->country ?? '') == 'ca' ? 'selected' : '' }}>Canadá</option>
                        </select>
                        @error('country')
                            <p class="error-message">{{ $message }}</p>
                        @enderror
