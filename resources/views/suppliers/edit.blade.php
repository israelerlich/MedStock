...
<div class="bg-white shadow sm:rounded-lg">
    <div class="px-4 py-5 sm:p-6">
        <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Editar Fornecedor</h3>
        ...
        <form action="{{ route('suppliers.update', $supplier) }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div>
                    ...
                    <input type="text" name="company_name" id="company_name" value="{{ old('company_name', $supplier->company_name) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="commercial_name" id="commercial_name" value="{{ old('commercial_name', $supplier->commercial_name) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="cnpj" id="cnpj" value="{{ old('cnpj', $supplier->cnpj) }}" required
            ...
            <div class="mt-8 pt-8 border-t border-gray-200">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="cep" id="cep" value="{{ old('cep', $supplier->address->cep ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="city" id="city" value="{{ old('city', $supplier->address->city ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="state" id="state" value="{{ old('state', $supplier->address->state ?? '') }}"
                            placeholder="SP"
                    ...
                    <div>
                        ...
                        <input type="text" name="district" id="district" value="{{ old('district', $supplier->address->district ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="street" id="street" value="{{ old('street', $supplier->address->street ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="address_number" id="address_number" value="{{ old('address_number', $supplier->address->address_number ?? '') }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="complement_number" id="complement_number" value="{{ old('complement_number', $supplier->address->complement_number ?? '') }}"
                    ...
                    <div>
                        ...
                        <select name="country" id="country"
                            ...
                            <option value="br" {{ old('country', $supplier->address->country ?? 'br') == 'br' ? 'selected' : '' }}>Brasil</option>
                            <option value="us" {{ old('country', $supplier->address->country ?? '') == 'us' ? 'selected' : '' }}>Estados Unidos</option>
                            <option value="ca" {{ old('country', $supplier->address->country ?? '') == 'ca' ? 'selected' : '' }}>Canadá</option>
                        </select>
                        @error('country')
                            <p class="error-message">{{ $message }}</p>
                        @enderror
