...
<div class="bg-white shadow sm:rounded-lg">
    <div class="px-4 py-5 sm:p-6">
        <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Editar Endereço</h3>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div>
                    ...
                    <select name="referring_type" id="referring_type" required
                        ...
                        <option value="App\Models\Client" {{ old('referring_type', $address->referring_type) == 'App\Models\Client' ? 'selected' : '' }}>Cliente</option>
                        <option value="App\Models\Hospital" {{ old('referring_type', $address->referring_type) == 'App\Models\Hospital' ? 'selected' : '' }}>Hospital</option>
                        <option value="App\Models\Supplier" {{ old('referring_type', $address->referring_type) == 'App\Models\Supplier' ? 'selected' : '' }}>Fornecedor</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="referring_id" id="referring_id" value="{{ old('referring_id', $address->referring_id) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="cep" id="cep" value="{{ old('cep', $address->cep) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="address_number" id="address_number" value="{{ old('address_number', $address->address_number) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="complement_number" id="complement_number" value="{{ old('complement_number', $address->complement_number) }}"
                ...
                <div>
                    ...
                    <input type="text" name="district" id="district" value="{{ old('district', $address->district) }}" required
                ...
                <div>
                    ...
                    <select name="country" id="country" required
                        ...
                        @foreach(\App\Enums\Country::cases() as $country)
                            <option value="{{ $country->value }}" {{ old('country', $address->country->value) == $country->value ? 'selected' : '' }}>
                                {{ $country->label() }}
                            </option>
                        @endforeach
                    </select>
